  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow">
        ...
        {/* ⚠️ Shop by Category (COMMENTED OUT) */}
        {/*
              ...
              {categories.slice(0, 3).map((category) => (
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-black/30 flex items-center justify-center">
                    <h3 className="text-white text-xl font-serif text-center">
                      {category.name}
                    </h3>
                  </div>
                </Link>
        ...
        */}
        ...
        {/* ⬇️ Values & Why Choose Us MOVED AT LAST */}
        <section>
          <Values />
        </section>
        ...
        {/* Testimonials stays Last before Footer */}
        <Testimonials />
      </main>
