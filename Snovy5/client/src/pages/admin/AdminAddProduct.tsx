...
const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
  ...
  // FIX: include _id + images array for ProductCard compatibility
  // const previewProduct: Product | null =
  //   form.name && files.length > 0 && form.price
  //     ? ({
  //         id: "preview",
  ...
  // FIX: BackendProduct typing match
const previewProduct =
  form.name && files.length > 0 && form.price
    ? ({
        ...
        category: form.category,
        description: form.description,
        images: files.map((file) => URL.createObjectURL(file)), // ProductCard expects this
        stock: form.stock ? Number(form.stock) : 0,
        createdAt: new Date(),
      } as any) // 👈 bypass strict type for preview
    : null;
