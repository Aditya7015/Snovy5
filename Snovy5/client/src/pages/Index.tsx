...
const HomePage = () => {
  ...
  const limit = 20; // show 20 products each page
  ...
  useEffect(() => {
    async function load() {
      try {
        const data = await fetchProducts(page, limit); // <-- updated
        setProducts(data);
      } catch (error) {
        console.error("Error fetching products:", error);
      }
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow">
        ...
        <section className="py-20 bg-secondary">
          <div className="container-custom">
            <h2 className="text-3xl md:text-4xl font-serif mb-10">Latest Products</h2>
