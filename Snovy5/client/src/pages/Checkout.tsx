...
// Payment types – COD only for now
type PaymentMethod = "cod" | "online-soon";
...
const Checkout = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    shippingZip: "",
    shippingCountry: "India",
    paymentMethod: "cod" as PaymentMethod, // ✅ default COD
    cardNumber: "",
    cardExpiry: "",
    cardCvv: "",
    saveInfo: true,
  ...
  const handleSubmit = async (e: any) => {
    ...
    // ❌ completely remove card validation – COD only now
    // if (formData.paymentMethod === "credit-card") { ... }
    ...
    try {
      setLoading(true);
      const order = await createOrder(cart, shippingAddress, billingAddress);
      clearCart();
      navigate(`/order-confirmation/${order.id}`);
    } catch (error: any) {
      toast.error(error.message || "Error placing your order");
      ...
      <div className="flex flex-col min-h-screen">
        ...
        <div className="container-custom flex-grow py-16">
          ...
          <div className="text-center py-16">
            <h2 className="text-2xl font-medium mb-4">Your cart is empty</h2>
            <p className="mb-8 text-muted-foreground max-w-lg mx-auto">
              Looks like you haven't added any Snovy5 apparel yet. Explore our
              latest drops and pick your favourite fits.
            </p>
            <Button onClick={() => navigate("/shop")}>Shop Collection</Button>
          </div>
        </div>
        ...
        <div className="container-custom flex-grow py-16">
          ...
          <div className="max-w-md mx-auto">
            <Card>
              ...
              <CardContent>
                <p className="mb-4">
                  An account helps you track your orders and get updates on new
                  Snovy5 drops.
                </p>
              </CardContent>
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow container-custom py-10">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8 gap-3">
          <div>
            <h1 className="text-3xl font-serif mb-1">Snovy5 Checkout</h1>
        ...
        <form onSubmit={handleSubmit}>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            ...
            <div className="space-y-6 lg:col-span-2">
              ...
              <Card className="border border-primary/10 shadow-sm">
                <CardHeader>
                  ...
                  <CardDescription>
                    We’ll use these details to share order updates.
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <Card className="border border-primary/10 shadow-sm">
                <CardHeader>
                  ...
                  <CardDescription>
                    Pay easily with Cash on Delivery. Online payments will be
                    available soon.
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <RadioGroup
                    ...
                    className="space-y-3"
                  >
                    <div className="flex items-center space-x-3 border rounded-lg p-4 bg-background">
                      <RadioGroupItem value="cod" />
                    ...
                    <div className="flex items-center space-x-3 border rounded-lg p-4 opacity-60 cursor-not-allowed">
                      <RadioGroupItem value="online-soon" disabled />
                      <div className="flex flex-col">
                        <Label className="font-medium">
                          Online Payment (Coming Soon)
                        </Label>
                        <span className="text-xs text-muted-foreground">
                          UPI / Cards / Wallets will be available in the next
                          update.
                        </span>
                      </div>
                    </div>
            ...
            <div className="lg:col-span-1">
              <div className="bg-secondary p-6 rounded-xl sticky top-24 shadow-md space-y-4">
                ...
                <div className="space-y-3 pt-2 text-sm">
                  ...
                  <p className="text-[11px] text-emerald-600">
                    You’re paying on delivery. No extra COD charges.
                  </p>
                </div>
